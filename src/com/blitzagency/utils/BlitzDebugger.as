/**
 * 
 * This is just a combo of MonsterDebugger and Mr.doob stats and sound disabling.
 * 
 * --== MonsterDebugger ==--
 * 
...
package com.blitzagency.utils
{
	...
	public class BlitzDebugger extends UIBase
	{
		
		// Singleton instance
		private static var instance:BlitzDebugger = null;
		...
		protected var mdRoot:Object = null;
		...
		public function BlitzDebugger( target:Object = null, disableSounds:Boolean = true, monster:Boolean = true, doob:Boolean = true )
		{
			// --------------==================== MONSTER DEBUGGER ====================-------------- //
		...
		{
			if (instance == null) instance = new BlitzDebugger(null);
			if (BlitzDebugger.enabled) instance.snapshotInternal(target, color);
		}
		...
		{
			if (instance == null) instance = new BlitzDebugger(target);
			if (BlitzDebugger.enabled) instance.traceInternal(target, object, color, functions, depth);
		}
		...
		{
			if (instance == null) instance = new BlitzDebugger(null);
			if (BlitzDebugger.enabled) instance.clearTracesInternal();
		}
